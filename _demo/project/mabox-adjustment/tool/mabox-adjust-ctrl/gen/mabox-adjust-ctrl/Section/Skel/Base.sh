...
base_var_init () {
	...
	## https://github.com/samwhelp/play-ubuntu-20.04-plan/blob/master/project/openboxrc-profile/mabox-adjust-ctrl/mabox-adjust-ctrl
	THE_SELF_UPDATE_URL='https://raw.githubusercontent.com/samwhelp/note-about-mabox/gh-pages/_demo/project/openboxrc-profile/mabox-adjust-ctrl/mabox-adjust-ctrl'
