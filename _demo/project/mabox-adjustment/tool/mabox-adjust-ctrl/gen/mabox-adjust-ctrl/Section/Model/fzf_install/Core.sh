...
mod_mabox_adjustment_fzf_module_install () {

	#util_error_echo "mod_mabox_adjustment_fzf_module_install"
	#util_error_echo "$@"
	...
	mod_mabox_adjustment_module_install "${choose_module}" "${choose_action}"
